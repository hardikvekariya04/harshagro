...
$current_date = "select max(date) AS date from taluka_data LIMIT 1";
$date_result = mysqli_query($con, $current_date);
$row_date = mysqli_fetch_assoc($date_result);

$date_current = $row_date['date']; 

$current_min_date = "select min(date) AS date from taluka_data LIMIT 1";
...
// echo  date('Y-m-d', $date3);
  ...
  // // $query =$con->query("SELECT min_temp,date from taluka_data where taluka_id = 2 AND date > date_sub('2018-09-30',Interval 1 month)" );
...
$six_monthly =date("Y - M",strtotime($monthly5));
  //$query =$con->query("SELECT min_temp,date from taluka_data where taluka_id = 2 AND date IN(date_sub('$query_Date',Interval 1 month))" );
  $query =$con->query("SELECT min_temp,date from taluka_data where taluka_id = 2 AND (date_sub('2018-09-30',Interval 1 month)) < date && date <= '2018-09-30'");
...
$query3 =$con->query("SELECT min_temp,date from taluka_data where taluka_id = 2 AND  (date_sub('$monthly',Interval 1 month)) < date && date <= '$monthly'" );
...
$query4 =$con->query("SELECT min_temp,date from taluka_data where taluka_id = 2 AND (date_sub('$monthly1',Interval 1 month)) < date && date <= '$monthly1'" );
...
$query5 =$con->query("SELECT min_temp,date from taluka_data where taluka_id = 2 AND (date_sub('$monthly2',Interval 1 month)) < date && date <= '$monthly2'" );
...
$query6 =$con->query("SELECT min_temp,date from taluka_data where taluka_id = 2 AND (date_sub('$monthly3',Interval 1 month)) < date && date <= '$monthly3'" );
...
$query7 =$con->query("SELECT min_temp,date from taluka_data where taluka_id = 2 AND (date_sub('$monthly4',Interval 1 month)) < date && date <= '$monthly4'" );
...
$query8 =$con->query("SELECT min_temp,date from taluka_data where taluka_id = 2 AND (date_sub('$monthly5',Interval 1 month)) < date && date <= '$monthly5'" );
...
$query3 =$con->query("SELECT min_temp,date from taluka_data where taluka_id = 1 AND (date_sub('2020-12-30',Interval 1 year)) < date && date <= '2020-12-30'");
  while($row3 = $query3->fetch_assoc()){
      $year[] = $row3['min_temp'];
      $year_date[] = $row3['date'];
    }
...
$query4 =$con->query("SELECT min_temp,date from taluka_data where taluka_id = 1 AND (date_sub('$yearly_one_date',Interval 1 year)) < date && date <= '$yearly_one_date'");
  while($row4 = $query4->fetch_assoc()){
      $year1[] = $row4['min_temp'];
...
//  echo $avg_high_year_temp1;
 ...
 $query5 =$con->query("SELECT min_temp,date from taluka_data where taluka_id = 1 AND (date_sub('$yearly_one_date',Interval 1 year)) < date && date <= '$yearly_one_date'");
 while($row5 = $query5->fetch_assoc()){
     $year5[] = $row5['min_temp'];
