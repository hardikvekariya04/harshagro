          ...
          <div class="col-lg-4 col-md-8 col-12 mx-auto">
            ...
            ?>
                <form role="form" class="text-start" action="" method="POST" name="login">
                  ...
                  <a href="404.php" style="text-decoration-line: none; color: rgb(0, 119, 255);" id="input3">Forgot Password ?</a>
                  <div class="form-check form-switch d-flex align-items-center mb-3">
                    <input class="form-check-input" type="checkbox" id="rememberMe">
                    <label class="form-check-label mb-0 ms-2" for="rememberMe">Remember me</label>
                  </div>
                  <div class="text-center">
                    <button type="submit" class="btn bg-gradient-primary w-100 my-4 mb-2" name="login_submit">Sign in</button>
                  </div>
