 ...
 $dto->modify('-7 days');
  ...
  $query41 =$con->query("SELECT NDVI  from `taluka_crop` where t_id = ".$t_id."  AND week = '$weeknumber41' AND year = '$month_date41'" );
    ...
    $query45 =$con->query("SELECT NDVI  from `taluka_crop` where t_id = ".$t_id."  AND week = '$weeknumber45' AND year = '$month_date45'" );
      ...
      $twelve_month_avg[] = array_sum($month_final11)/count($month_final12);
        ...
        $date_array1 = array_merge($twelve_month_date,$eleven_month_date,$ten_month_date,$nine_month_date,$eight_month_date,$seven_month_date,$six_month_date,$five_month_date,$four_month_date,$third_month_date,$second_month_date,$one_month_date);
        $final_month_array1 = array_merge($twelve_month_avg,$eleven_month_avg,$ten_month_avg,$nine_month_avg,$eight_month_avg,$seven_month_avg,$six_month_avg,$five_month_avg,$four_month_avg,$third_month_avg,$second_month_avg,$one_month_avg);
