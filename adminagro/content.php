...
if (isset($_POST['uploadfile'])) {
    ...
    $db = mysqli_connect("localhost", "root", "", "admin_agro");
        $sql = "INSERT INTO about_content(content) VALUES ('$content')";
        mysqli_query($db, $sql);       
        if ($sql) {
...
<body class="g-sidenav-show  bg-gray-200">
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder mb-0">Added content</h6>
        </nav>
  ...
  <form method="post" enctype="multipart/form-data">
   <div align="center">  
    ...
    <div>
        <label>Content</label>
        <textarea type="text" name="content" class="form-control" rows="4" cols="50"></textarea>
        <br><br>
